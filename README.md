...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-inlinedocs-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-inlinedocs-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-inlinedocs-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-inlinedocs-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-inlinedocs-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-inlinedocs-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-inlinedocs/badges/version.svg)](https://anaconda.org/conda-forge/r-inlinedocs)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-inlinedocs/badges/downloads.svg)](https://anaconda.org/conda-forge/r-inlinedocs)
